                ...
                if (activeNetwork != null && activeNetwork.isConnectedOrConnecting()) {
                    ...
                    switch (connectionType) {
                        ...
                        case ConnectivityManager.TYPE_MOBILE ->
                                Log.d("Connection", "Using Mobile Data");
        ...
        private void showUpdateDialog() {
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, urlU, null, jsonObject -> {
                try {
                    ...
                    Log.e("Settings", "Beta:" + versionsCodeBeta + ", Normal:" + versionsCode + ", Wants beta:" + settingsPreferences.getBoolean("wantsBeta", false));
                    ...
                    if (finalVersionsCodeBeta > versionC && settingsPreferences.getBoolean("wantsBeta", false)) {
                        Log.e("Settings", "beta");
                            new MaterialAlertDialogBuilder(requireContext(), com.google.android.material.R.style.ThemeOverlay_Material3_MaterialAlertDialog_Centered)
                                    ...
                                    .setPositiveButton("Update", (dialog, which) -> InstallUpdate(requireContext(), finalApkUrlBeta1, finalVersionsNameBeta1))
                            ...
                            new MaterialAlertDialogBuilder(requireContext(), com.google.android.material.R.style.ThemeOverlay_Material3_MaterialAlertDialog_Centered)
                                    ...
                                    .setPositiveButton("Update", (dialog, which) -> InstallUpdate(requireContext(), finalApkUrl1, finalVersionsName1))
                                    .setNeutralButton(getString(R.string.later), (dialog, which) -> dialog.cancel())
                                    .show();
                        }
